            ...
            <div className="wrapper d-flex justify-content-center align-items-center">
                {showScore ? (
                    <div className="container d-flex justify-content-center align-items-center">
                        <div className=" bg-dark p-5 text-light shadow rounded d-flex flex-column justify-content-center align-items-center">
                            <h1 className="text-info">Your Result</h1>
                    ...
                    <div className="quiz container d-flex flex-column bg-light shadow-lg col-7">
                        <div className="row py-2 px-3 bg-dark text-light shadow rounded align-items-start">
                            <div className="quiz-header">
                                <div className="col d-flex justify-content-between">
                                    <h2 className="m-1 ">QUIZ! </h2>
                                    <p className="m-0 fs-4 fw-bold font-monospace"></p>
                                </div>
                            </div>
                        </div>
                        <div className="quiz-body row px-3 mt-3 mb-auto bd-dark text-dark">
                        ...
                        <div className="quiz-footer row mt-4 py-2">
                            <div className="col d-flex justify-content-end">
                                <button className="btn btn-outline-danger px-4" onClick={nextQuestion}>Next</button>
                            </div>
                        </div>
                    </div>
                )}
